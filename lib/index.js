...
export default class Timeline extends Component {
      ...
      case "single-column-left":
        content = (
          <View style={[styles.rowContainer, this.props.rowContainerStyle]}>
            ...
            {this.renderEvent(rowData, index)}
  ...
  _renderEvent(rowData, index) {
    ...
    return (
      ...
      >
        ...
        >
          <View style={[styles.detail, this.props.eventContainerStyle]}>
  ...
  _renderCircle(rowData) {
    ...
    const innerCircleProp = this.props.innerCircle || rowData.innerCircle;
    switch (innerCircleProp) {
      case "icon":
